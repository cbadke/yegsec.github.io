...
BLOG_TITLE = "YEGSec"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://yegsec.ca/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://yegsec.ca/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Info site for YEGSec, Edmonton's security community group"  # (translatable)
...
TWITTER_CARD = {
    ...
    'site': '@yegsec',         # twitter nick for the website
    'creator': '@yegsec',     # Username for the content creator / author.
}
